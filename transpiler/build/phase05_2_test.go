...
// TestPhase5_2Option runs the Phase 5.2 fixture suite.
// It walks tests/transpiler3/beam/fixtures/phase05_2/ and asserts that
// each fixture's escript stdout matches expect.txt byte-for-byte.
func TestPhase5_2Option(t *testing.T) {
	root := repoRoot(t)
	fixturesDir := filepath.Join(root, "tests", "transpiler3", "beam", "fixtures", "phase05_2")
	...
	if ran == 0 {
		t.Fatal("no fixtures found in phase05_2/")
	}
}
