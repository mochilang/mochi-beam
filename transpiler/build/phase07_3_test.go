...
// TestPhase7_3HashJoin runs the Phase 7.3 fixture suite.
// It walks tests/transpiler3/beam/fixtures/phase07_3/ and asserts that
// each fixture's escript stdout matches expect.txt byte-for-byte.
func TestPhase7_3HashJoin(t *testing.T) {
	root := repoRoot(t)
	fixturesDir := filepath.Join(root, "tests", "transpiler3", "beam", "fixtures", "phase07_3")
	...
	if ran == 0 {
		t.Fatal("no fixtures found in phase07_3/")
	}
}
